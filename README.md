...
说明
全员业绩排名
"Full Rank""导出全员业绩排名""展示所有有效业绩排名"
自动筛选有效数据、换算泰铢、按业绩降序展示完整排名
单人业绩查询
"Query THCC-Sara""查询某人业绩""某人的排名是多少"
输入人名，直接返回该人员的全球排名及泰铢业绩
自动登录CRM
"登录51Talk CRM""获取业绩数据"
内置固定账号密码，自动登录目标CRM页面，无需手动输入
数据筛选过滤
"筛选有效业绩""排除无效人员"
自动排除指定黑名单人员，仅保留付款金额>200USD的有效数据
汇率自动换算
"美元转泰铢""业绩换算成泰铢"
按固定汇率1:34，自动将美元业绩转换为泰铢，仅展示泰铢结果
核心功能详情
1. 全员业绩排名（Full Rank）
触发指令：Full Rank
...
2. 向AI助手发送触发指令，两种指令可选：
  ...
  - 需要全员排名：发送Full Rank，AI自动完成全流程，返回排名表格
...
Cursor
.cursor/skills/Thai-CC-Operation/
Trae
.trae/skills/Thai-CC-Operation/
Windsurf
.windsurf/skills/Thai-CC-Operation/
Claude Code
.claude/skills/Thai-CC-Operation/
通用
.agents/skills/Thai-CC-Operation/
示例：安装到 Qoder
